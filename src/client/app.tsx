          ...
          {conversations.map((conv) => (
            <div
              ...
              className={`p-2 rounded cursor-pointer ${
                conv.id === currentConvId ? "bg-primary text-primary-foreground" : "hover:bg-muted"
              }`}
            >
              {conv.title}
            </div>
                              ...
                              <div key={i}>
                                <Card
                                  className={`p-3 rounded-md ${
                                    isUser ? "bg-primary text-primary-foreground rounded-br-none" : "rounded-bl-none border-assistant-border"
